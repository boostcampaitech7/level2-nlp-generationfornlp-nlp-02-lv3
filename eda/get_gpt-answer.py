...
client = OpenAI(api_key="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")
...
for index, row in df.iterrows():
    ...
    try:
        ...
        answer_parsed = re.search(r'\b[1-4]\b', answer)  # 1에서 4까지의 숫자만 찾음
